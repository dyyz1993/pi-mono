...
Stateful agent with tool execution and event streaming. Built on `@dyyz1993/pi-ai`.

## Installation

```bash
npm install @dyyz1993/pi-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@dyyz1993/pi-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@dyyz1993/pi-agent-core";
