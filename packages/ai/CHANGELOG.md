...
- Added OAuth login flow metadata so clients can present interactive provider choices during login ([#4190](https://github.com/dyyz1993/pi-mono/pull/4190) by [@mitsuhiko](https://github.com/mitsuhiko)).
...
- Fixed the Kimi K2 P6 model alias to normalize to `kimi-for-coding` ([#4218](https://github.com/dyyz1993/pi-mono/issues/4218)).
