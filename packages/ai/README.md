...
```bash
npm install @dyyz1993/pi-ai
```

TypeBox exports are re-exported from `@dyyz1993/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@dyyz1993/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@dyyz1993/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@dyyz1993/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@dyyz1993/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@dyyz1993/pi-ai';
...
```typescript
import { getModel, stream } from '@dyyz1993/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@dyyz1993/pi-ai';
...
```typescript
import { Model, stream } from '@dyyz1993/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@dyyz1993/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@dyyz1993/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@dyyz1993/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@dyyz1993/pi-ai/oauth` entry point in Node.js.
...
```bash
npx @dyyz1993/pi-ai login              # interactive provider selection
npx @dyyz1993/pi-ai login anthropic    # login to specific provider
npx @dyyz1993/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@dyyz1993/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@dyyz1993/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@dyyz1993/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@dyyz1993/pi-ai';
import { getOAuthApiKey } from '@dyyz1993/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@dyyz1993/pi-ai`
