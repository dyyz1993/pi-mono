...
import { type CallLLMFn, MemoryDream, MemoryExtractor, updateMemoryIndex } from "../../extensions/auto-memory/index.js";
import {
	DREAM_MIN_HOURS,
	DREAM_MIN_SESSIONS,
	getMemoryDir,
...
describe("auto-memory rpc-e2e-errors", () => {
	...
	describe("Extension handles memory dir with corrupted files", () => {
		...
		it("prefetch handles corrupt content without crash", async () => {
			...
			const { MemoryPrefetch } = await import("../../extensions/auto-memory/index.js");
