...
describe("dangerous bash patterns", () => {
	it.each([
		...
		{
			description: "blocks rm -r in normal mode",
			toolName: "bash",
			input: { command: "rm -r delegated_permission_probe/" },
			permissionMode: "normal",
		...
		{
			description: "blocks rm --recursive in normal mode",
			toolName: "bash",
			input: { command: "rm --recursive delegated_permission_probe/" },
			permissionMode: "normal",
			expected: { block: true, reasonContains: "dangerous bash" },
		},
		{
			description: "blocks rm -fr in normal mode",
			toolName: "bash",
			input: { command: "rm -fr /tmp/data" },
			permissionMode: "normal",
			expected: { block: true, reasonContains: "dangerous bash" },
		},
		{
