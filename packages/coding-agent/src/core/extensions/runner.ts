...
import type { ExtensionLLMCallOptions } from "./types.js";
...
export class ExtensionRunner {
	...
	private callModelFn: (options: ExtensionLLMCallOptions) => Promise<AgentMessage> = async () => {
	...
	bindCore(
		...
		this.callModelFn = contextActions.callModel;
