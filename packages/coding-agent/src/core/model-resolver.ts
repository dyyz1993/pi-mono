...
import { type Api, type KnownProvider, type Model, modelsAreEqual } from "@dyyz1993/pi-ai";
...
export function resolveCliModel(options: {
	...
	const { cliProvider, cliModel, cliThinking, modelRegistry, tierModels } = options;
