...
Requirements: Node.js >= 23.6.0 for `@dyyz1993/gondolin`, plus QEMU (requires installation through your package manager).
...
RUN npm install -g --ignore-scripts @dyyz1993/pi-coding-agent
