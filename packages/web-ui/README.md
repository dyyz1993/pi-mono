...
Reusable web UI components for building AI chat interfaces powered by [@dyyz1993/pi-ai](../ai) and [@dyyz1993/pi-agent-core](../agent).
...
```bash
npm install @dyyz1993/pi-web-ui @dyyz1993/pi-agent-core @dyyz1993/pi-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@dyyz1993/pi-web-ui';
import '@dyyz1993/pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@dyyz1993/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@dyyz1993/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@dyyz1993/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@dyyz1993/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@dyyz1993/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@dyyz1993/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@dyyz1993/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@dyyz1993/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@dyyz1993/pi-web-ui';
...
```typescript
import { ModelSelector } from '@dyyz1993/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@dyyz1993/pi-web-ui';
