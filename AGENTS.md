...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/dyyz1993/pi-mono/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/dyyz1993/pi-mono/pull/456) by [@username](https://github.com/username))`
